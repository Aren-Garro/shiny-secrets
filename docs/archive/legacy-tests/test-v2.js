 ...
 * 
 * NOTE: This is a LEGACY test file. The project now uses Jest for testing.
 * See tests/core.test.js for current test suite.
 * This file is archived for reference and backward compatibility.
 */
